  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4 ">
        <div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            {tags.map((label, key) => (
              <span
                key={key}
                className="h-8 text-sm text-zinc-400 bg-zinc-50/5 grid items-center px-3
              rounded-lg"
              >
                {label}
              </span>
        ...
        <div className="w-11 h-11 rounded-lg grid place-items-center text-zinc-950 shrink-0">
